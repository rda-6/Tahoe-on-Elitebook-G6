...
- SMBIOS needs to be set to something compatible with macOS Tahoe **during the installation** (MacBookPro16,2 for my instance) and then needs to be switched to something more compatible (like MacBookPro15,4) **after the installation**
